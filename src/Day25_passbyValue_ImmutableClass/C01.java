...
public class C01 {
    ...
    public static void main(String[] args) {
        ...
        nasıl çalışır? Eğer method'da "New" diye yeni bir değer ataması yoksa,
         sadece elementler değişiyorsa,
        o zaman bizim main method'daki elementler de değişmiş olur.
         Yani araba aynı, yolcular değişmiş olur.
        Ama eğer method'da "New" keyword ile objemize yeni bir değer atanmışsa,
        o zaman o yeni methoda atanan
        değer method'da kalır, bizim main method'daki hem List'imiz ve
        Array'imiz hem de içindeki elementler
